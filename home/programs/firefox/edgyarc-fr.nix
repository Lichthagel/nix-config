...
let
  enable = config.programs.firefox.licht.edgyarc-fr;
...
in
{
  options.programs.firefox.licht = {
    edgyarc-fr = lib.mkEnableOption "edgyarc-fr";
  };
  ...
  config = lib.mkIf enable {
    ...
    home.file.".mozilla/firefox/default/chrome".source = "${edgyarc-fr}/chrome";
  };
}
